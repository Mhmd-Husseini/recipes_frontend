        ...
        <div className='modal-form-container'>
            <div className='form-container'>
                ...
                <div>
                    ...
                    <input name='description' value={data.description} onChange={handleDataChange} placeholder='Enter description' />
                </div>
                <div>
                    <label>Directions:</label>
                    <input name='directions' value={data.directions} onChange={handleDataChange} placeholder='Enter directions' />
                </div>
                <div>
                <label>Images:</label>
